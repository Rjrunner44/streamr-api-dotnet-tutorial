...
namespace IO.Swagger.Model
{
    ...
    public partial class FieldDefinition :  IEquatable<FieldDefinition>, IValidatableObject
    {
        ...
        public FieldDefinition(string name = default(string), TypeEnum type = default(TypeEnum))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FieldDefinition and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for FieldDefinition and cannot be null");
            }
            else
            {
                this.Type = type;
