...
namespace IO.Swagger.Model
{
    ...
    public partial class DashboardItem :  IEquatable<DashboardItem>, IValidatableObject
    {
        ...
        public DashboardItem(string id = default(string), string title = default(string), int? ord = default(int?), SizeEnum? size = default(SizeEnum?), string uiChannelId = default(string))
        {
            this.Id = id;
            this.Title = title;
            this.Ord = ord;
        ...
        /// </summary>
        /// <value>unique identifier of item</value>
